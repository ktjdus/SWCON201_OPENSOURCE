...
UNPROTECTED_FILES = [
    ...
    # TODO: remove the lines under once we can specify folders that are not top level/use fnmatch or glob for files
    "localstack-pro-core/localstack/pro/core/appinspector/database/alembic/env.py",
    "localstack-pro-core/localstack/pro/core/appinspector/database/alembic/versions/443b451f15d0_initial_schema_setup_for_eventstudio.py",
    "localstack-pro-core/localstack/pro/core/appinspector/database/alembic/versions/d568b67cab7a_add_span_limit_trigger.py",
    "localstack-pro-core/localstack/pro/core/appinspector/database/alembic/versions/e8f9a12c6d4b_add_links_column_to_spans.py",
    "localstack-pro-core/localstack/pro/core/appinspector/database/alembic/versions/f7a3c9b8d5e2_add_event_type_column_to_events.py",
]
