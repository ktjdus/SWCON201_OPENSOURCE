...
class AcceleratorCountRequest(TypedDict, total=False):
    ...
    min: Optional[BoxedInteger]
    max: Optional[BoxedInteger]
...
class NetworkBandwidthGbpsRequest(TypedDict, total=False):
    ...
    min: Optional[BoxedDouble]
    max: Optional[BoxedDouble]
...
class InstanceRequirementsRequest(TypedDict, total=False):
    ...
    spotMaxPricePercentageOverLowestPrice: Optional[BoxedInteger]
    onDemandMaxPricePercentageOverLowestPrice: Optional[BoxedInteger]
    bareMetal: Optional[BareMetal]
    burstablePerformance: Optional[BurstablePerformance]
    requireHibernateSupport: Optional[BoxedBoolean]
    ...
    maxSpotPriceAsPercentageOfOptimalOnDemandPrice: Optional[BoxedInteger]
...
class ManagedInstancesStorageConfiguration(TypedDict, total=False):
    ...
    storageSizeGiB: Optional[TaskVolumeStorageGiB]
...
class InstanceLaunchTemplate(TypedDict, total=False):
    ...
    storageConfiguration: Optional[ManagedInstancesStorageConfiguration]
    monitoring: Optional[ManagedInstancesMonitoringOptions]
...
class ManagedInstancesProvider(TypedDict, total=False):
    ...
    instanceLaunchTemplate: Optional[InstanceLaunchTemplate]
    propagateTags: Optional[PropagateMITags]
...
class CapacityProvider(TypedDict, total=False):
    ...
    managedInstancesProvider: Optional[ManagedInstancesProvider]
    updateStatus: Optional[CapacityProviderUpdateStatus]
    updateStatusReason: Optional[String]
    tags: Optional[Tags]
    type: Optional[CapacityProviderType]
...
class CreateCapacityProviderRequest(ServiceRequest):
    ...
    cluster: Optional[String]
    autoScalingGroupProvider: Optional[AutoScalingGroupProvider]
    managedInstancesProvider: Optional[CreateManagedInstancesProviderConfiguration]
    tags: Optional[Tags]
...
class InstanceLaunchTemplateUpdate(TypedDict, total=False):
    ...
    networkConfiguration: Optional[ManagedInstancesNetworkConfiguration]
    storageConfiguration: Optional[ManagedInstancesStorageConfiguration]
    monitoring: Optional[ManagedInstancesMonitoringOptions]
    instanceRequirements: Optional[InstanceRequirementsRequest]
...
class UpdateCapacityProviderRequest(ServiceRequest):
    name: String
    cluster: Optional[String]
    autoScalingGroupProvider: Optional[AutoScalingGroupProviderUpdate]
    managedInstancesProvider: Optional[UpdateManagedInstancesProviderConfiguration]
