...
class RecoveryPointCreator(TypedDict, total=False):
    ...
    BackupPlanName: Optional[string]
    BackupPlanVersion: Optional[string]
    BackupRuleId: Optional[string]
    BackupRuleName: Optional[string]
    BackupRuleCron: Optional[string]
    BackupRuleTimezone: Optional[string]
...
class BackupJob(TypedDict, total=False):
    ...
    VaultType: Optional[string]
    VaultLockState: Optional[string]
    RecoveryPointArn: Optional[ARN]
    RecoveryPointLifecycle: Optional[Lifecycle]
...
class CopyJob(TypedDict, total=False):
    ...
    DestinationVaultType: Optional[string]
    DestinationVaultLockState: Optional[string]
    DestinationRecoveryPointArn: Optional[ARN]
    DestinationEncryptionKeyArn: Optional[ARN]
    DestinationRecoveryPointLifecycle: Optional[Lifecycle]
    ResourceArn: Optional[ARN]
    CreationDate: Optional[timestamp]
    CompletionDate: Optional[timestamp]
...
class GetBackupPlanInput(ServiceRequest):
    BackupPlanId: string
    VersionId: Optional[string]
    MaxScheduledRunsPreview: Optional[MaxScheduledRunsPreview]
...
class ScheduledPlanExecutionMember(TypedDict, total=False):
    ...
    ExecutionTime: Optional[timestamp]
    RuleId: Optional[string]
    RuleExecutionType: Optional[RuleExecutionType]
...
class GetBackupPlanOutput(TypedDict, total=False):
    ...
    LastExecutionDate: Optional[timestamp]
    AdvancedBackupSettings: Optional[AdvancedBackupSettings]
    ScheduledRunsPreview: Optional[ScheduledRunsPreview]
