...
class UrlRewriteConfig(TypedDict, total=False):
    ...
    Rewrites: Optional[RewriteConfigList]
...
class RuleTransform(TypedDict, total=False):
    ...
    HostHeaderRewriteConfig: Optional[HostHeaderRewriteConfig]
    UrlRewriteConfig: Optional[UrlRewriteConfig]
...
class HttpHeaderConditionConfig(TypedDict, total=False):
    ...
    Values: Optional[ListOfString]
    RegexValues: Optional[ListOfString]
...
class CreateRuleInput(ServiceRequest):
    ...
    Actions: Actions
    Tags: Optional[TagList]
    Transforms: Optional[RuleTransformList]
...
class ModifyRuleInput(ServiceRequest):
    ...
    Actions: Optional[Actions]
    Transforms: Optional[RuleTransformList]
    ResetTransforms: Optional[ResetTransforms]
